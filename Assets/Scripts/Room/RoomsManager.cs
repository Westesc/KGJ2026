        ...
        switch (exitDoor)
        {
            case DoorType.Top:
                ...
                seq.Append(playerInfo.playerTransform.DOMoveZ(
                    enterRoom.bottomDoors.transform.position.z + (enterRoom.bottomDoors.GetCurrentTrigger().size.z + 2), transitionTime / 2f));
            ...
            case DoorType.Bottom:
                ...
                seq.Append(playerInfo.playerTransform.DOMoveZ(
                    enterRoom.topDoors.transform.position.z - (enterRoom.topDoors.GetCurrentTrigger().size.z + 2), transitionTime / 2f));
            ...
            case DoorType.Left:
                ...
                seq.Append(playerInfo.playerTransform.DOMoveX(
                    enterRoom.rightDoors.transform.position.x - (enterRoom.rightDoors.GetCurrentTrigger().size.x + 2), transitionTime / 2f));
            ...
            case DoorType.Right:
                ...
                seq.Append(playerInfo.playerTransform.DOMoveX(
                    enterRoom.leftDoors.transform.position.x + (enterRoom.leftDoors.GetCurrentTrigger().size.x + 2), transitionTime / 2f));
